...
const char str[7][10] = {"cleder", "torch", "hum", "clock", "press", "step","more"};
	...
	while(1)
	{
		...
		else if(key_data.exdata == 1)
		{
			...
			switch(dock_pos)
			{
				...
				case 5: vTaskResume(xShowStepTaskHandle);vTaskSuspend(NULL);key_data.exdata = 0;break;
				case 6: vTaskResume(xShowSettingTaskHandle);vTaskSuspend(NULL);key_data.exdata = 0;break;
			}
		}
